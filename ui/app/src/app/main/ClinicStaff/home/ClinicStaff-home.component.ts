...
@Component({
  selector: 'ClinicStaff-home',
  templateUrl: './ClinicStaff-home.component.html',
  styleUrls: ['./ClinicStaff-home.component.scss']
})
export class ClinicStaffHomeComponent implements AfterViewInit {
