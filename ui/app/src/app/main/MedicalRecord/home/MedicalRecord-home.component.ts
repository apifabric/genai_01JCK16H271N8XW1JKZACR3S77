...
@Component({
  selector: 'MedicalRecord-home',
  templateUrl: './MedicalRecord-home.component.html',
  styleUrls: ['./MedicalRecord-home.component.scss']
})
export class MedicalRecordHomeComponent implements AfterViewInit {
