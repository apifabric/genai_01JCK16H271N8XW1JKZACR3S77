...
resourcename="medicalclinicsystem"  # lower case, only
resourcegroup="medicalclinicsystem_rg"
...
# git clone https://github.com/apilogicserver/medicalclinicsystem.git
# cd medicalclinicsystem
...
az group create --name medicalclinicsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group medicalclinicsystem_rg --sku S1 --is-linux
az container create --resource-group medicalclinicsystem_rg --name medicalclinicsystem --image apilogicserver/medicalclinicsystem:latest --dns-name-label medicalclinicsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//medicalclinicsystem.westus.azurecontainer.io:5656'
